<a href="{{ route('doctor.dashboard') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm {{ request()->routeIs('doctor.dashboard') ? 'active' : 'text-slate-600' }}">
...
<a href="{{ route('doctor.appointments.index') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm {{ request()->routeIs('doctor.appointments.*') ? 'active' : 'text-slate-600' }}">
...
<a href="{{ route('doctor.prescriptions.index') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm {{ request()->routeIs('doctor.prescriptions.*') ? 'active' : 'text-slate-600' }}">
...
<a href="{{ route('doctor.lab-tests.index') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm {{ request()->routeIs('doctor.lab-tests.*') ? 'active' : 'text-slate-600' }}">
...
<a href="{{ route('queue.index') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm {{ request()->routeIs('queue.*') ? 'active' : 'text-slate-600' }}">
